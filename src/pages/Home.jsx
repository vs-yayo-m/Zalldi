...
export default function Home() {
  ...
  const { user } = useAuth()
  const { products, loading, fetchProducts } = useProducts({ limit: 20, featured: true })
  ...
  const bestsellerProducts = products.filter(p => p.soldCount > 0).sort((a, b) => b.soldCount - a.soldCount).slice(0, 8)
